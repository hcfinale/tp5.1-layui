<?php /*a:3:{s:37:"E:\www\tp5\/tpl/admin/detail\add.html";i:1563257825;s:40:"E:\www\tp5\/tpl/admin/Public\header.html";i:1555291684;s:40:"E:\www\tp5\/tpl/admin/Public\footer.html";i:1555291684;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
		<meta charset="UTF-8">
...
<div class="layui-content">
	...
	<div class="layui-row">
		<div class="layui-col-lg-offset1 layui-col-xs10">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="new_price" required  lay-verify="required" placeholder="请输入商品价格" autocomplete="off" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						...
						<script type="text/plain" id="editor" name="content" style="width:100%;height:400px;"></script>
					</div>
				</div>
				<?php echo token(); ?>
				<div class="layui-form-item">
