<?php /*a:3:{s:43:"E:\www\tp5\/template/admin/column\edit.html";i:1554462865;s:45:"E:\www\tp5\/template/admin/Public\header.html";i:1554259509;s:45:"E:\www\tp5\/template/admin/Public\footer.html";i:1554258877;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
		<meta charset="UTF-8">
...
<div class="layui-content">
	<div class="layui-page-header">
		<div class="pagewrap">
			...
			<h2 class="title"><?php echo htmlentities($columnName); ?></h2>
		</div>
	</div>
	<div class="layui-row">
		<div class="layui-col-lg-offset3 layui-col-lg6 layui-col-xs-offset1 layui-col-xs10">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="title" required  lay-verify="required" placeholder="<?php echo htmlentities($column['title']); ?>" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<img src="<?php echo htmlentities($column['img']); ?>" alt="" width="30%" height="auto" id="columnImg" />
						<input type="hidden" value="<?php echo htmlentities($column['img']); ?>" name="img" id="columnimgs">
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">关键词</label>
					<div class="layui-input-block">
						<textarea name="keyword" placeholder="请输入内容" class="layui-textarea"><?php echo htmlentities($column['keyword']); ?></textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">描述</label>
					<div class="layui-input-block">
						<textarea name="description" placeholder="请输入内容" class="layui-textarea"><?php echo htmlentities($column['description']); ?></textarea>
					</div>
				</div>
				<?php echo token(); ?>
				<div class="layui-form-item">
...
layui.use(['form','upload'], function(){
	...
	form.on('submit(edit)', function(data){
		var data = data.field;
		console.log(data);
		$.post("<?php echo url('column/edit'); ?>",data,function(res){
			if(res.code == '1001'){
				layer.msg(res.data);
				setTimeout(function () {
