<?php /*a:3:{s:39:"E:\www\tp5\/tpl/admin/detail\index.html";i:1561600846;s:40:"E:\www\tp5\/tpl/admin/Public\header.html";i:1555291684;s:40:"E:\www\tp5\/tpl/admin/Public\footer.html";i:1555291684;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    	<meta charset="UTF-8">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="layui-btn-group">
                                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="hc_move('修改栏目','<?php echo url("detail/edit",["id"=>$vo["id"]]); ?>')">
                                    <i class="layui-icon">&#xe65f;</i>
                                </button>
                                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="hc_edit('修改栏目','<?php echo url("detail/edit",["id"=>$vo["id"]]); ?>')">
                                    <i class="layui-icon">&#xe642;</i>
                                </button>
                                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="hc_del('','<?php echo url("detail/del",["id"=>$vo["id"]]); ?>')">
                                    <i class="layui-icon">&#xe640;</i>
                                </button>
                            </div>
                        </td>
...
window.onload = function(){
    layui.use(['form','layer'], function(){
        ...
        form.on('switch', function(data) {
            ...
            $.ajax({
                method: 'post',
                url: '<?php echo url("detail/status"); ?>',
                data: {
                    id: id,
                },
                dataType: 'json',
